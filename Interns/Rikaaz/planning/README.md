...
[`ai-ambassador-gcc-1week-plan.md`](./ai-ambassador-gcc-1week-plan.md) — a 1-week GTM starter plan for the AI Ambassador (msg2ai Events) in the GCC. Use it as a model for structure: clear goal, measurable weekly targets, and a phase-by-phase breakdown with an outcome per phase.
